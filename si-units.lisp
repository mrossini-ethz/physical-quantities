...
(defun define-si-units (&key clear-existing-units)
  ...
  (define-unit |litre| :def (1 |decimetre| ^ 3) :alias |liter| :abbrev (|l| |L|) :prefix-test (prefix-range 10 nil 2))
  ...
  (define-unit |electron| :def (1.6021765314d-19 |coulomb|) :abbrev |e| :prefix-test (prefix-range 10 3 nil))
  (define-unit |electronvolt| :def (1 |electron| |volt|) :abbrev |eV| :prefix-test (prefix-base 10 3))
  (define-unit |dalton| :def (1.6605388628d-27 |kilogram|) :abbrev (|u| |Da|) :prefix-test (constantly nil)))
