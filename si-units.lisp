...
(defun define-si-units (&key clear-existing-units)
  ...
  (define-unit astronomical-unit :def (149597870700 metre) :abbrev au :prefix-test (constantly nil))
  (define-unit electronvolt :def (1.6021765314d-19 joule) :abbrev ev :prefix-test (prefix-base 10 3))
  (define-unit atomic-mass :def (1.6605388628e-27 kilogram) :abbrev u :prefix-test (constantly nil)))
